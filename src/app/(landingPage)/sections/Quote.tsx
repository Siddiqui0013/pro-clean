...
export default function Quote() {
	return (
		<div className="py-8 md:px-4 max-w-7xl md:mx-auto flex flex-col md:flex-row md:items-center items-start justify-between">
			<div className="w-full md:w-1/2 px-12 py-8 flex items-start flex-col gap-6 ">
				...
				<h1 className="text-4xl md:text-5xl font-extrabold md:pr-8">
