    ...
    <section className="py-16 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid md:grid-cols-3 gap-6 items-stretch">
        {[
          ...
          <div
            key={idx}
            className="bg-gray-50 rounded-lg shadow-sm overflow-hidden flex flex-col h-full 
            transition hover:bg-[#0A6259] group"
          >
            ...
            <div className="py-6 px-4 flex flex-col flex-grow">
              <p className="text-gray-600 group-hover:text-white transition">Erik Hamilton</p>
              <h3 className="text-2xl font-semibold mb-4 text-gray-900 group-hover:text-white transition">
                {blog.title}
              </h3>
              <p className="text-gray-700 mb-6 group-hover:text-white transition">
                {blog.desc}
              </p>
              <Link
                href="#"
                className="mt-auto inline-flex items-center justify-center rounded-md border-t border-gray-300 px-4 py-2 font-medium
                 group-hover:text-[#0A6259] bg-[#0A6259] text-white group-hover:bg-white transition"
              >
                Read More
              </Link>
            </div>
