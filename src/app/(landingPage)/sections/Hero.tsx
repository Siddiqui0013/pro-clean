...
export default function Hero() {
  return (
    ...
    className="flex items-start md:h-[550px] flex-col gap-6 mx-auto py-12 px-6">
      ...
      <Link href={"/get-a-quote"} className="bg-primary px-4 md:px-8 py-2 md:py-4 rounded-md text-white">Book Now</Link>
      <Link href={"#services"} className="bg-transparent border-primary px-4 md:px-8 py-2 md:py-4 rounded-md primary">Our Services</Link>
      </div>
      </div>
    </div>
  )
